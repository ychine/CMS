...
<body class="w-full h-screen bg-[#020A27] px-10 pt-3 flex items-start justify-center">
    ...
    <div class="w-full h-full flex flex-row rounded-t-[15px] overflow-hidden bg-gray-200 shadow-lg">
        ...
        <div class="flex-1 flex flex-col h-full ">
            ...
            <div class="bg-white px-[50px] py-[20px] h-[67px] flex justify-between items-center w-full box-border" style="box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.3); z-index: 0;">
            ...
            <!-- Dynamic Content -->
            <iframe id="contentIframe" src="profile_frame.php" class="w-full flex-1 fade-in" frameborder="0" style="z-index: 0;"></iframe>
