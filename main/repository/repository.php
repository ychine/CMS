...
<head>
    ...
    <title>Repository | CourseDock</title>
    ...
    <div class="w-full h-full flex flex-row rounded-t-[15px] overflow-hidden bg-gray-200 shadow-lg">
        ...
        <div id="sidebar" class="w-[290px] bg-[#1D387B] text-white p-3 pt-5 flex flex-col transition-all duration-300 ease-in-out">
            ...
            <div class="p-2 flex flex-col gap-[8px]">
                ...
                <a href="../repository/repository.php" class="bg-[#13275B]  menu-item flex items-center px-7 py-3 h-[53px] border-2 border-[#2A4484] text-[16px] font-onest text-[#E3E3E3] font-[400] rounded-[10px] hover:bg-[#13275B] active:border-[#51D55A] cursor-pointer transition">
        ...
        <div class="flex-1 flex flex-col h-full ">
            ...
            <!-- Dynamic Content -->
            <iframe id="contentIframe" src="repository_frame.php" class="w-full flex-1 fade-in" frameborder="0"></iframe>
